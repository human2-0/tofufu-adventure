...
func _farmstead() -> void:
	seed_bank = FarmBuildings.seed_bank(self, ground_point(-22, -22))
...
func _village() -> void:
	...
	FarmBuildings.cottage(self, ground_point(30, 0), "EQUIPMENT SHOP", Color("aa7e89"), Vector3(5.8, 3.1, 4.6))
	...
	weapon_merchant = FarmBuildings.resident(self, ground_point(29, 3.7), "Kaji · Gear", Color("b98791"))
	quest_npc = FarmBuildings.resident(self, ground_point(30, 18), "Mayor Mame", Color("7c99bb"), true)
	map_npcs["Kaji · Gear"] = weapon_merchant
